...
## Chart Graphs for top 10 events causing fatalities, injuries and loss of property
...
```
### Now plot totalInjuries by Event type
```{r}
...
### Now plot totalPropertyDamages by Event type
```{r}
...
```
## Results
The charts above would suggest that Tornadoes are the number one reason for fatalities and injuries. Looking at the property damages the conclusions is the same. Tornadoes lead to the most property damage in totality across the country.
